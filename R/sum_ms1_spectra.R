...
#'
#' @param mzMLPath (character) The path to the mzML file. Required.
#' @param PPM_Round (numeric) Number to round to in PPM. Default is 5.
#' @param MinimumAbundance (numeric) The minimum abundance value to keep. Acceptable values
#'    range from 0 to 100. Default is 0.01.
#' @param Messages (boolean) A TRUE/FALSE to indicate whether help messages should be printed or not.
#'    Default is TRUE.
#'
#' @details
...
#'
#' @returns (peak_data object) A peak_data object with summed MS1 spectra. This object can be directly
